...
class ConfirmInfo extends StatelessWidget {
  ...
  IdImagesController controller =
      Get.put(IdImagesController(), permanent: false);
  @override
  Widget build(BuildContext context) {
    ...
    //                                         },
    //                                         imageUrl:
    //                                             "ApiConstants.imagebaseUrl+model.identity_back!",
    //                                         width: 96.0,
    //                                         height: 96.0,
    ...
    //                                     controller.image2.uri.toString().isEmpty
    //                                         ? CachedNetworkImage(
    //                                             imageBuilder:
    //                                                 (context, imageProvider) {
    //                                               return Container(
    ...
    //                                             },
    //                                             imageUrl:
    //                                                 "ApiConstants.imagebaseUrl+model.identity_face!",
    //                                             width: 96.0,
    //                                             height: 96.0,
    //                                             placeholder: (context, url) {
    //                                               return SvgPicture.asset(
    ...
    //                             height: 30.h,
    //                           ),
    //                     controller.hide1 || controller.hide2
    //                         ? const SizedBox()
    //                         : Row(
    //                             children: [
    //                               Expanded(
    ...
    //                                     controller.image3.uri.toString().isEmpty
    //                                         ? CachedNetworkImage(
    //                                             imageBuilder:
    //                                                 (context, imageProvider) {
    //                                               return Container(
    ...
    //                                             },
    //                                             imageUrl:
    //                                                 "ApiConstants.imagebaseUrl+ model.passport_image!",
    //                                             width: 96.0,
    //                                             height: 96.0,
    //                                             placeholder: (context, url) {
    //                                               return SvgPicture.asset(
    ...
    //                                 UploadID.isUploadedImg2) ||
    //                             UploadID.isUploadedImg3) {
