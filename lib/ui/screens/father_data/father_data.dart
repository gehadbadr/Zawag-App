...
class FatherInfo extends StatefulWidget {
  FatherInfo({Key? key}) : super(key: key);
                              ...
                              if (controller.questions?.questions[x].type ==
                                ...
                                return Center(
                                  child: SingleChoice(
                                    ...
                                    idQuestion:
                                        controller.questions!.questions[x].id,
                                    answers: controller
                                        .questions!.questions[x].answers,
                                    question: controller
                                        .questions!.questions[x].content,
                                  ),
                                );
                                          ...
                                          onPressed: () {
                                            if (controller
                                              ...
                                              if (controller
                                                      ...
                                                      .type ==
                                                  1) {
                                                controller.textAnswer(controller
                                                    .questions!
                                                    .questions[
                                                        controller.pageIndex]
                                                    .id);
